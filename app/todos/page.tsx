...
//         <select name="category" className="border px-2 rounded">
//           <option value="faks">Mirela</option>
//           <option value="posao">Ajsa</option>
//           <option value="skola">Esma</option>
//         </select>
//       </form>
//     </div>
//   );
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <p className="text-sm text-gray-500 mb-4">
        {todos.filter((t) => !t.completed).length} od {todos.length} preostalo
      </p>

      {todos.length === 0 ? (
        <p className="text-gray-500 text-center py-8">
          Nema zadataka. Dodaj prvi!
        </p>
      ) : (
        <ul className="flex flex-col gap-2">
          {todos.map((todo) => (
            <li
              key={todo.id}
              className="flex items-center gap-3 bg-white p-4 rounded-lg border
